...
root.title("Welcome Ajay Chat house")
...
title_label = Label(title_frame, text="Ajay Chat house",
                    font=("times new roman", 20, "bold"),bg = "yellow", fg="blue", pady=5)
title_label.pack()
...
order_title_label = Label(order_frame, text="Your Order", 
                    font=("times new roman", 20, "bold"),bg = "lightgreen", fg="Black")
...
total_price_label = Label(order_frame, text="Total Price", 
                    font=("arial", 12, "bold"),bg = "yellow", fg="blue")
